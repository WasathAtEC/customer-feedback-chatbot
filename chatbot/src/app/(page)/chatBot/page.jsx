        ...
        <div className="max-w-md mx-auto my-10 shadow-md rounded-xl bg-[#C7EFF8]">
            ...
            <div className="px-10 pt-2 pb-8">
                <div className="w-auto h-10 px-[21px] py-[9px] bg-gray-400 bg-opacity-50 rounded-[20px] shadow border border-stone-600 border-opacity-20 justify-center items-center gap-2.5 inline-flex mb-3">
                    <p className="text-stone-950 text-opacity-70 text-[16px] font-semibold ">Hi, I'm DOC ChatBot</p>
                </div>
                ...
                <div className="flex justify-center">
                    ...
                    <p className="outline-dashed outline-2 outline-offset-0 rounded-lg bg-[#9ACAF6] opacity-58 text-blue-600 text-opacity-90 text-md font-semibold font-['Inter'] leading-[25px] px-4 py-1 mt-2">Support Form</p></Link>
                </div>
            </div>
